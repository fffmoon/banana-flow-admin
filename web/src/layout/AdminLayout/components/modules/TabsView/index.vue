...
.tabs-container {
  ...
  .tab-item {
    --at-apply: 'base-ani active:btn-active  hover:btn-hover relative h-[calc(var(--tabs-view-height)-(var(--space-sm)*2))] flex cursor-pointer select-none items-center b-1px b-color-[var(--custom-divider-color)] rounded-[var(--custom-border-radius)] b-solid bg-[var(--custom-card-color)] text-[var(--custom-text-color-3)]';
