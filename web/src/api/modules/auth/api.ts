 ...
 */
import type { GetPermmenuResponse, GetUserInfoResponse, LoginResponse, LoginRquest, SmsCodeRequestPayload, UserPasswordUpdateParams, UserProfileUpdateParams } from './type'
...
// 登录，通过账户名称
export function loginWithAccountName(data: LoginRquest) {
...
/**
 * 更新个人资料
 * 对应后端: PUT /api/v1/users/me
 */
export function updateMe(data: UserProfileUpdateParams) {
  return request<GetUserInfoResponse>({
    url: '/api/v1/users/me',
    method: 'put',
    data,
...
/**
 * 修改个人密码
 * 对应后端: PUT /api/v1/users/me/password
 */
export function changePassword(data: UserPasswordUpdateParams) {
  return request<any>({
